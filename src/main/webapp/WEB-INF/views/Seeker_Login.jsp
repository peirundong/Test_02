...
<div class="login_wrapper">
    ...
    <div class="login_box">
        <form id="loginForm" action="/sys/SeekerDoLogin.html">
            <p><input type="hidden" id="companysalt" value="9b207beb1e014a93bc852b7ba450db27" />
            <p><input type="text" id="seekerphone" class="inputs" name="seekerphone"
                      tabindex="1" placeholder="请输入手机号" /></p>

            <p><input type="password" id="seekerpwd" class="inputs" name="seekerpwd"
            ...
            <input type="button" id="submitReturn" onclick="location.href='/sys/SeekerRegister.html'" value="注 &nbsp; &nbsp; 册" />
        </form>
    </div>
