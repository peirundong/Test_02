                        ...
                        <div class="filter_options  dn " style="display: none;">
                          <%--  <dl>
                                ...
                                <dd>
                                    ...
                                    <a rel="1年" href="javascript:;">一年以下</a>
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <a rel="1" href="javascript:;">大专</a>
                                    <a rel="2" href="javascript:;">本科</a>
                                    <a rel="3" href="javascript:;">硕士</a>
                                    <a rel="4" href="javascript:;">博士</a>
                                ...
                                <c:forEach var="resume" items="${resumeList }" varStatus="status">
                                    ...
                                    <div class="resumeShow" style="height: 80px ;padding-top: 15px">
                                        <a title="预览在线简历" target="_blank" class="resumeImg"
                                           href="/sys/Company_Introduction.html?id=${companyid}">
...
<div id="footer" style="width: 100%;height: 240px;border: 1px solid red;"></div>
