    ...
    <div class="content">
        <dl class="company_center_content">
            ...
            <dd style="text-align: left">
                <form action="${pageContext.request.contextPath }/sys/Resume/Resume_InterviewSeeker.html" method="get">
                            ...
                            <c:forEach var="resume" items="${resumeList }" varStatus="status">
                                <div class="resumeShow" style="height: 80px ;padding-top: 15px">
                                    ...
                                    <div class="links">
                                        <label>已投递公司</label>
                                        <a
                                           href="/sys/Company_Introduction.html?companyid=${resume.companyid}">${resume.companyname }</a>
                                    </div>
                                </div>
                            </c:forEach>
                        </li>
