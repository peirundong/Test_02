...
<head>
    ...
    <script type="text/javascript" src="../../statics/js/company.min.js"></script>
...
<div class="login_wrapper">
    ...
    <div class="login_box">
        <form id="loginForm" action="/sys/CompanyDoRegister.html" method="post">
            <input  type="hidden" id="typevalueid" class="inputs" name="typevalueid"
                   tabindex="1" value="0">
            <p><input type="hidden" id="companysalt" value="9b207beb1e014a93bc852b7ba450db27" />
            <p><input type="text" id="companyName" class="inputs" name="companyname"
                      tabindex="1" placeholder="请输入公司名字"></p>
            <p><input type="text" id="companyaccount" class="inputs" name="companyaccount"
                      tabindex="2" placeholder="请输入注册公司账号"/></p>
            <p><input type="text" id="companyPhone" class="inputs" name="companyphone"
                      tabindex="1" placeholder="请输入常用手机号" /></p>
            <p><input type="text" id="phone_passwrod" class="inputs" name="phone_passwrod"
                      tabindex="1" placeholder="请输入验证码" /></p>
            <p><input type="text" id="companyemail" class="inputs" name="companyemail" tabindex="1"
                      placeholder="请输入常用邮箱地址" /></p>
            <p><input type="password" id="companypwd" class="inputs" name="companypwd"
            ...
            <p><input type="text" id="companyinformation" class="inputs" name="companyinformation"
                   tabindex="2" placeholder="请输入公司信息" /></p>
            ...
            <input type="button" id="submitReturn" onclick="location.href='/sys/CompanyLogin.html'" value="返 &nbsp; &nbsp; 回" />
        </form>
    </div>
