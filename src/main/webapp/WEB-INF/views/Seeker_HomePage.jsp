...
<script src="../../statics/js/Seeker_HomePage.js" type="text/javascript"/>
    ...
    <div id="container">
        <div id="sidebar">
            ...
            <div class="mainNavs">
                <div class="menu_box">
                    <div class="menu_main">
                        <h2>技术 <span></span></h2>
                        <%--href="/controller?name=python"--%>
                        <a href="${pageContext.request.contextPath }/sys/searchA?name=java">Java</a>
                        <a href="${pageContext.request.contextPath }/sys/searchA?name=PHP">PHP</a>
                        <a href="${pageContext.request.contextPath }/sys/searchA?name=C">C</a>
                        <a href="${pageContext.request.contextPath }/sys/searchA?name=C++">C++</a>
                        <a href="${pageContext.request.contextPath }/sys/searchA?name=Android">Android</a>
                        <a href="${pageContext.request.contextPath }/sys/searchA?name=iOS">iOS</a>
                        <a href="${pageContext.request.contextPath }/sys/searchA?name=前端开发">前端开发</a>
                        <a href="${pageContext.request.contextPath }/sys/searchA?name=测试">测试</a>
                        <a href="${pageContext.request.contextPath }/sys/searchA?name=技术经理">技术经理</a>
                        <a href="${pageContext.request.contextPath }/sys/searchA?name=项目经理">项目经理</a>
                        <a href="${pageContext.request.contextPath }/sys/searchA?name=架构师">架构师</a>
                    </div>
        ...
        <div class="content">
            <div id="search_box">
                <form id="searchForm" name="searchForm" action="${pageContext.request.contextPath }/sys/search" method="post">
                    <ul id="searchType">
                ...
                <ul class="banner_bg">
                    <li class="banner_bg_1 current">
                        <a href="h/subject/s_buyfundation.html?utm_source=DH__lagou&utm_medium=banner&utm_campaign=haomai"
                           target="_blank"><img src="../../statics/Images/d05a2cc6e6c94bdd80e074eb05e37ebd.jpg"
                    ...
                    <li class="banner_bg_2">
                        <a href="h/subject/s_worldcup.html?utm_source=DH__lagou&utm_medium=home&utm_campaign=wc"
                           target="_blank"><img src="../../statics/Images/c9d8a0756d1442caa328adcf28a38857.jpg"
                    ...
                    <li class="banner_bg_3">
                        <a href="h/subject/s_xiamen.html?utm_source=DH__lagou&utm_medium=home&utm_campaign=xiamen"
                           target="_blank"><img src="../../statics/Images/d03110162390422bb97cebc7fd2ab586.jpg"
                ...
                <div class="banner_control">
                    ...
                    <ul class="thumbs">
                        <li class="thumbs_1 current">
                            <i></i>
                            <img src="../../statics/Images/4469b1b83b1f46c7adec255c4b1e4802.jpg" width="113"
                                 height="42"/>
                        </li>
                        <li class="thumbs_2">
                            <i></i>
                            <img src="../../statics/Images/381b343557774270a508206b3a725f39.jpg" width="113"
                                 height="42"/>
                        </li>
                        <li class="thumbs_3">
                            <i></i>
                            <img src="../../statics/Images/354d445c5fd84f1990b91eb559677eb5.jpg" width="113"
                                 height="42"/>
                        </li>
                    </ul>
                </div>
            ...
            <ul id="da-thumbs" class="da-thumbs">
                <li>
                    <a href="h/c/1650.html" target="_blank">
                        <img src="../../statics/Images/a254b11ecead45bda166afa8aaa9c8bc.jpg" width="113" height="113"
                             alt="联想"/>
                        <div class="hot_info">
                            <h2 title="联想">联想</h2>
                            <em></em>
                ...
                <li>
                    <a href="h/c/9725.html" target="_blank">
                        <img src="../../statics/Images/c75654bc2ab141df8218983cfe5c89f9.jpg" width="113" height="113"
                             alt="淘米"/>
                        <div class="hot_info">
                            <h2 title="淘米">淘米</h2>
                            <em></em>
                ...
                <li>
                    <a href="h/c/1914.html" target="_blank">
                        <img src="../../statics/Images/2bba2b71d0b0443eaea1774f7ee17c9f.png" width="113" height="113"
                             alt="优酷土豆"/>
                        <div class="hot_info">
                ...
                <li>
                    <a href="h/c/6630.html" target="_blank">
                        <img src="../../statics/Images/f4822a445a8b495ebad81fcfad3e40e2.jpg" width="113" height="113"
                             alt="思特沃克"/>
                        <div class="hot_info">
                ...
                <li>
                    <a href="h/c/2700.html" target="_blank">
                        <img src="../../statics/Images/5caf8f9631114bf990f87bb11360653e.png" width="113" height="113"
                             alt="奇猫"/>
                        <div class="hot_info">
                            <h2 title="奇猫">奇猫</h2>
                            <em></em>
                ...
                <li class="last">
                    <a href="h/c/1335.html" target="_blank">
                        <img src="../../statics/Images/c0052c69ef4546c3b7d08366d0744974.jpg" width="113" height="113"
                             alt="堆糖网"/>
                        <div class="hot_info">
                            <h2 title="堆糖网">堆糖网</h2>
                            <em></em>
            ...
            <div id="hotList">
                ...
                <a href="${pageContext.request.contextPath }/sys/mainlistpage.html" class="btn fr" target="_blank">查看更多</a>
            </div>
            <div class="clear"></div>
        </div>
        <script type="text/javascript" src="../../statics/js/Chart.min.js"></script>
        <script type="text/javascript" src="../../statics/js/home.min.js"></script>
        <script type="text/javascript" src="../../statics/js/count.js"></script>
        <div class="clear"></div>
