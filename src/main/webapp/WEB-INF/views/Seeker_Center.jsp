...
<html xmlns:wb="http://open.weibo.com/wb"><head>
    </script><script type="text/javascript" async="" src="../../statics/js/conversion.js"></script><script src="/statics/js/allmobilize.min.js" charset="utf-8" id="allmobilize"></script><style type="text/css"></style>
    ...
    <link rel="stylesheet" href="../../statics/css/ui.css"><link rel="stylesheet" href="css/window.css">
</head>
<body>
<div id="body">
    ...
    <div id="container">
        ...
        <div class="content">
            <dl class="company_center_content"></dl>
        </div><!-- end .content -->
